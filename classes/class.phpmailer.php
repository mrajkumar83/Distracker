...
class phpmailer
{
    ...
    function mail_send($header, $body) {
        ...
        {
            //echo $to,'--' , $this->Subject,'--' , $body,'--' ,$header;
    ...
    function smtp_send($header, $body) {
        ...
        $smtp = new SMTP;
		//echo $header,'<hr>', $body,'<hr>',$this->From;
		...
		/* 
		** Commented as we are able to send mails and these issues are coming from server */
