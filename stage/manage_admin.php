<?php
	...
	$title =  'Research Tracking System | Manage Users';
	...
	$result = $db->fetchAllRecord(' tb_users ' , ' user_id,user_name,user_fullname,user_email ', ' user_type="AD" AND user_status="A" AND user_id <> "'.$UID.'"' , NULL, '  user_name', NULL, 0,'All');
?>
<div id="main">
	<div id="sts"></div>
	<div class="top-bar"><h1>Manage Admin's</h1></div>
