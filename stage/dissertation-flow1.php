...
{
	$userdata = $db->fetchRecord(' vw_dissertation_details i ', ' i.std_id, i.std_name, i.std_photo, i.con_name, i.chrt_id, i.chrt_name, i.dist_name, i.dist_desc, DATE_FORMAT(i.dist_doc, "%b-%e- %Y") dist_doc, i.lang_name, i.email ', '  i.dist_id="'.$did.'" ');
}	
